defmodule AiAgent.Embeddings.FixTest do
  ...
  def test_long_text_embedding do
    ...
    """ |> String.duplicate(500)  # This creates a ~25,000 character text
  ...
  def test_vector_storage do
    ...
    test_content = "This is a test document for vector storage. It contains information about testing embeddings."
  ...
  def test_both_fixes do
    ...
    test_docs = [
      ...
      %{
        content: String.duplicate("This is a very long email that would normally cause issues with token limits. ", 200),
